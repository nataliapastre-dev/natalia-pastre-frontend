      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          <p
            ...
            "
          >
            Conheça minha trajetória, evolução profissional e a conexão entre
          ...
          >
            ...
            >
              ...
              <p className="text-slate-400 leading-8 mb-5">
                Sou Natália Baptista Pastre, estudante de Análise e
                Desenvolvimento de Sistemas e desenvolvedora Front-End focada
                na criação de aplicações modernas, responsivas e centradas na
              ...
              <p className="text-slate-400 leading-8">
                Atualmente aplico essa experiência no desenvolvimento de
